...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'classrepresentator' => \App\Http\Middleware\RedirectIfNotClassrepresentator::class,
        'classrepresentator.guest' => \App\Http\Middleware\RedirectIfClassrepresentator::class,
