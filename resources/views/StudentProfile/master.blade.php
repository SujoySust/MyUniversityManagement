...
<head>
    ...
    <!--gallery -->
    <link type="text/css" rel="stylesheet" href="{{asset('Student/')}}/css/cm-overlay.css" />
    <!-- //gallery -->
...
<div id="home" class="banner" style="background: url(../{{$profile->background}})no-repeat center 0px fixed;">
    <div class="banner-agileinfo">
    @include('StudentProfile.Include.header')
        @include('StudentProfile.Include.banner')
