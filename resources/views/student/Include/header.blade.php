                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                ...
                                <span class="time">{{$message->timed}} on {{$message->dated}}</span>
                                </span>
                                <span class="message">
                        ...
                        <li>
                            <a href="{{url('student/message/all')}}">See all messages</a>
                        </li>
                    </ul>
                </li>
                <!-- inbox dropdown end -->
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu extended logout">
                        <li><a href="{{url('studentProfile/').'/'.Auth::guard('student')->user()->id}}"><i class=" fa fa-suitcase"></i>Profile</a></li>
