        ...
        <div class="container">
            ...
            <div class="agileinfo-gallery-row">
                ...
                <div class="col-md-12" id="post">
                    <button type="button" id="formButton" class="btn btn-success" style="width: 100%">Add Post</button>
                    <div class="form-group" id="postform" >

                        <form class="form-group" method="POST" action="{{ url('student/post/save')}}" id="form1" style="display: none">
                            {{ csrf_field() }}
                            <div class="form-group">
                                {{--<label for="exampleTextarea">Post Details</label>--}}
                                <textarea  rows="3" id="tarea" name="post" style="min-width: 600px"></textarea>
                    ...
                    @foreach($allposts as $allpost)
                        ...
                        <div class=" w3gallery-grids" style="border: 1px solid #ffffff;margin-bottom: 1%;background: brown;padding: 2%;padding-bottom: 10%">
                            <div class="col-md-10">
                                <span><img src="{{asset($allpost->picture)}}" style="width: 5%;float: left;margin-right: 2%;border-radius: 50%"> <h4 style="margin-top: 1%">{{$allpost->name}}</h4></span>
                            </div>
                            ...
                            <div style="margin-left: 2%">
                                <P style="white-space: pre-line; color: black;margin-top: -15px;">
                                    {!! $allpost->post !!}
                                </p>
                            </div>
